...
func _entered_main_menu_scene(called_by : Node, resource_to_load : Resource, node_to_load : Node) -> void:
	for resource in current_loaded_scene_nodes_dictionary.keys():
		if resource.is_scene_type == SCENE_TYPE.LEVEL:
			_unload_node(called_by, resource, current_active_scene_nodes_dictionary[resource])
	...
	for resource in current_active_scene_nodes_dictionary.keys():
		if resource.is_scene_type == SCENE_TYPE.HUD:
			...
			_deactivate_node(called_by, resource, current_active_scene_nodes_dictionary[resource])
...
func _entered_pause_menu_scene(called_by : Node, resource_to_load : Resource, node_to_load : Node) -> void:
	for resource in current_active_scene_nodes_dictionary.keys():
		if resource.is_scene_type == SCENE_TYPE.MENU:
			# _hide_node(current_active_scene_nodes_dictionary[resource])
			_deactivate_node(called_by, resource, current_active_scene_nodes_dictionary[resource])
		else:
			_pause_node(called_by, resource, current_active_scene_nodes_dictionary[resource])
...
func _entered_settings_menu_scene(called_by : Node, resource_to_load : Resource, node_to_load : Node) -> void:
	for resource in current_active_scene_nodes_dictionary.keys():
		if resource.is_scene_type == SCENE_TYPE.MENU:
			# _hide_node(current_active_scene_nodes_dictionary[resource])
			_deactivate_node(called_by, resource, current_active_scene_nodes_dictionary[resource])
...
func _entered_load_game_menu_scene(called_by : Node, resource_to_load : Resource, node_to_load : Node) -> void:
	for resource in current_active_scene_nodes_dictionary.keys():
		if resource.is_scene_type == SCENE_TYPE.MENU:
			# _hide_node(current_active_scene_nodes_dictionary[resource])
			_deactivate_node(called_by, resource, current_active_scene_nodes_dictionary[resource])
...
func _entered_save_game_menu_scene(called_by : Node, resource_to_load : Resource, node_to_load : Node) -> void:
	for resource in current_active_scene_nodes_dictionary.keys():
		if resource.is_scene_type == SCENE_TYPE.MENU:
			# _hide_node(current_active_scene_nodes_dictionary[resource])
			_deactivate_node(called_by, resource, current_active_scene_nodes_dictionary[resource])
...
func _entered_new_game_menu_scene(called_by : Node, resource_to_load : Resource, node_to_load : Node) -> void:
	for resource in current_active_scene_nodes_dictionary.keys():
		if resource.is_scene_type == SCENE_TYPE.MENU:
			# _hide_node(current_active_scene_nodes_dictionary[resource])
			_deactivate_node(called_by, resource, current_active_scene_nodes_dictionary[resource])
...
func _entered_campaign_menu_scene(called_by : Node, resource_to_load : Resource, node_to_load : Node) -> void:
	for resource in current_active_scene_nodes_dictionary.keys():
		if resource.is_scene_type == SCENE_TYPE.MENU:
			# _hide_node(current_active_scene_nodes_dictionary[resource])
			_deactivate_node(called_by, resource, current_active_scene_nodes_dictionary[resource])
...
func _entered_game_over_menu_scene(called_by : Node, resource_to_load : Resource, node_to_load : Node) -> void:
	ConsoleLog.DEBUG(
		self,
...
func _entered_victory_menu_scene(called_by : Node, resource_to_load : Resource, node_to_load : Node) -> void:
	ConsoleLog.DEBUG(
		self,
...
func _entered_inventory_menu_scene(called_by : Node, resource_to_load : Resource, node_to_load : Node) -> void:
	for resource in current_active_scene_nodes_dictionary.keys():
		if resource.is_scene_type == SCENE_TYPE.MENU:
			# _hide_node(current_active_scene_nodes_dictionary[resource])
			_deactivate_node(called_by, resource, current_active_scene_nodes_dictionary[resource])
...
func _entered_character_stats_menu_scene(called_by : Node, resource_to_load : Resource, node_to_load : Node) -> void:
	for resource in current_active_scene_nodes_dictionary.keys():
		if resource.is_scene_type == SCENE_TYPE.MENU:
			# _hide_node(current_active_scene_nodes_dictionary[resource])
			_deactivate_node(called_by, resource, current_active_scene_nodes_dictionary[resource])
...
func _entered_skill_leveling_menu_scene(called_by : Node, resource_to_load : Resource, node_to_load : Node) -> void:
	for resource in current_active_scene_nodes_dictionary.keys():
		if resource.is_scene_type == SCENE_TYPE.MENU:
			# _hide_node(current_active_scene_nodes_dictionary[resource])
			_deactivate_node(called_by, resource, current_active_scene_nodes_dictionary[resource])
...
func _entered_level_hud_scene(called_by : Node, resource_to_load : Resource, node_to_load : Node) -> void:
	ConsoleLog.DEBUG(
		self,
...
func _entered_combat_hud_scene(called_by : Node, resource_to_load : Resource, node_to_load : Node) -> void:
	ConsoleLog.DEBUG(
		self,
...
func _entered_npc_interaction_hud_scene(called_by : Node, resource_to_load : Resource, node_to_load : Node) -> void:
	ConsoleLog.DEBUG(
		self,
...
func _entered_level_scene(called_by : Node, resource_to_load : Resource, node_to_load : Node) -> void:
	for resource in current_active_scene_nodes_dictionary.keys():
		if resource.is_scene_type == SCENE_TYPE.MENU:
			_deactivate_node(called_by, resource, current_active_scene_nodes_dictionary[resource])
		if resource.is_scene_type == SCENE_TYPE.HUD:
	...
	if last_active_scene_resources_type_dictionary[SCENE_TYPE.LEVEL] != null:
		_unload_node(called_by, last_active_scene_resources_type_dictionary[SCENE_TYPE.LEVEL], current_active_scene_nodes_dictionary[last_active_scene_resources_type_dictionary[SCENE_TYPE.LEVEL]])
	else:
		ConsoleLog.DEBUG(
			self,
	...
	if last_active_scene_resources_type_dictionary[SCENE_TYPE.COMBAT] != null:
		_unload_node(called_by, last_active_scene_resources_type_dictionary[SCENE_TYPE.COMBAT], current_active_scene_nodes_dictionary[last_active_scene_resources_type_dictionary[SCENE_TYPE.COMBAT]])
	else:
		ConsoleLog.DEBUG(
			self,
	...
	load_scene(called_by, "level_hud")
...
func _entered_tutorial_combat_fight_scene(called_by : Node, resource_to_load : Resource, node_to_load : Node) -> void:
	for resource in current_active_scene_nodes_dictionary.keys():
		if resource.is_scene_type == SCENE_TYPE.MENU:
			_deactivate_node(called_by, resource, current_active_scene_nodes_dictionary[resource])
		if resource.is_scene_type == SCENE_TYPE.HUD:
	...
	if last_active_scene_resources_type_dictionary[SCENE_TYPE.LEVEL] != null:
		_deactivate_node(called_by, last_active_scene_resources_type_dictionary[SCENE_TYPE.LEVEL], current_active_scene_nodes_dictionary[last_active_scene_resources_type_dictionary[SCENE_TYPE.LEVEL]])
	else:
		ConsoleLog.DEBUG(
			self,
	...
	load_scene(called_by, "combat_hud")
...
func _entered_random_encounter_combat_fight_scene(called_by : Node, resource_to_load : Resource, node_to_load : Node) -> void:
	for resource in current_active_scene_nodes_dictionary.keys():
		if resource.is_scene_type == SCENE_TYPE.MENU:
			_deactivate_node(called_by, resource, current_active_scene_nodes_dictionary[resource])
		if resource.is_scene_type == SCENE_TYPE.HUD:
...
func _entered_mission_encounter_combat_fight_scene(called_by : Node, resource_to_load : Resource, node_to_load : Node) -> void:
	for resource in current_active_scene_nodes_dictionary.keys():
		if resource.is_scene_type == SCENE_TYPE.MENU:
			_deactivate_node(called_by, resource, current_active_scene_nodes_dictionary[resource])
		if resource.is_scene_type == SCENE_TYPE.HUD:
...
func _entered_boss_fight_combat_scene(called_by : Node, resource_to_load : Resource, node_to_load : Node) -> void:
	for resource in current_active_scene_nodes_dictionary.keys():
		if resource.is_scene_type == SCENE_TYPE.MENU:
			_deactivate_node(called_by, resource, current_active_scene_nodes_dictionary[resource])
		if resource.is_scene_type == SCENE_TYPE.HUD:
...
func _entered_final_boss_fight_combat_scene(called_by : Node, resource_to_load : Resource, node_to_load : Node) -> void:
	for resource in current_active_scene_nodes_dictionary.keys():
		if resource.is_scene_type == SCENE_TYPE.MENU:
			_deactivate_node(called_by, resource, current_active_scene_nodes_dictionary[resource])
		if resource.is_scene_type == SCENE_TYPE.HUD:
...
func _emit_signal(called_by : Node, resource_to_emit : Resource, node_to_emit : Node, is_load : bool) -> void:
...
func _activate_node(called_by : Node, resource_to_activate : Resource, node_to_activate : Node) -> void:
	if _check_scene_node_active(resource_to_activate) == null:
		_process_active_nodes_depending_on_type_and_subtype(called_by, resource_to_activate, node_to_activate)
		...
		# _emit_signal(called_by, resource_to_activate, node_to_activate, true)


func _deactivate_node(called_by : Node, resource_to_deactivate : Resource, node_to_deactivate : Node) -> void:
...
func _pause_node(called_by : Node, resource_to_pause : Resource, node_to_pause : Node) -> void:
...
func _unpause_node(called_by : Node, resource_to_unpause : Resource, node_to_unpause : Node) -> void:
...
func _show_node(called_by : Node, resource_to_show : Resource, node_to_show : Node) -> void:
	node_to_show.show()
...
func _hide_node(called_by : Node, resource_to_hide : Resource, node_to_hide : Node) -> void:
	node_to_hide.hide()
...
func _unload_node(called_by : Node, resource_to_unload : Resource, node_to_unload : Node) -> void:
	_deactivate_node(called_by, resource_to_unload, node_to_unload)
	...
	_emit_signal(called_by, resource_to_unload, node_to_unload, false)


func _load_node(called_by : Node, resource_to_load : Resource) -> Node:
	var scene_node_to_load : Node = _check_scene_node_loaded(resource_to_load)

	if scene_node_to_load == null:
		scene_node_to_load = resource_to_load.scene_file.instantiate()

	current_loaded_scene_nodes_dictionary[resource_to_load] = scene_node_to_load

	_emit_signal(called_by, resource_to_load, scene_node_to_load, true)
...
func _process_active_nodes_depending_on_type_and_subtype(called_by : Node, resource_to_load : Resource, node_to_load : Node) -> void:
	...
	if callable_function.is_valid():
		callable_function.call(called_by, resource_to_load, node_to_load)
	else:
		ConsoleLog.ERROR(
			self,
...
func load_scene(called_by : Object, resource_name_to_load : String) -> void:
	...
	if scene_resource_to_load != null:
		var scene_node_to_load : Node = _load_node(called_by, scene_resource_to_load)
		_activate_node(called_by, scene_resource_to_load, scene_node_to_load)
...
func unload_scene(called_by : Object, resource_name_to_unload : String) -> void:
	...
	var scene_resource_to_unload : Resource = _check_resource_exists(resource_name_to_unload)

	if scene_resource_to_unload != null:
		_unload_node(called_by, scene_resource_to_unload, current_active_scene_nodes_dictionary[scene_resource_to_unload])
